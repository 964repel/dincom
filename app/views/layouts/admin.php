...
<head>
    ...
    <title>ДИНКОМ | Панель управления</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=PATH;?>" class="logo" target="_blank">
            ...
            <span class="logo-mini"><b>Д</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>ДИНКОМ</b></span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="logod.png" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="logod.png" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?=PATH;?>/user/logout" class="btn btn-default btn-flat">Log out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?= ADMIN ?>/order/"><i class="fa fa-shopping-cart"></i> <span>Заявки</span></a></li>
                <li class="treeview">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-calendar-plus-o"></i> <span>Мероприятия</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?= ADMIN ?>/event/add/">Добавить мероприятие</a></li>
                    </ul>
                </li>
